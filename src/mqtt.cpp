...
std::vector<uint32_t> kAuthBeeps{925, 70,   0,  10, 1165, 70,   0,
                                 10,  1386, 70, 0,  10,   1850, 70};
std::vector<uint32_t> kWrongBeeps{654, 100, 0, 10, 734, 100, 0, 10,
                                  824, 100, 0, 10, 654, 100, 0, 10,
                                  734, 100, 0, 10, 654, 100};
